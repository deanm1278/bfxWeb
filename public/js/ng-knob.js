...
(function() {
    ...
    var Knob = function(element, value, options) {
        ...
        this.inDrag = false;
        /* d3 V4 ease functions */
        this.animations = {
            lenear: d3.easeLinear,
    ...
    Knob.prototype.createArc = function(innerRadius, outerRadius, startAngle, endAngle, cornerRadius) {
        ...
        var arc = d3.arc().innerRadius(innerRadius).outerRadius(outerRadius).startAngle(startAngle).endAngle(endAngle).cornerRadius(cornerRadius);
        return arc;
    };
